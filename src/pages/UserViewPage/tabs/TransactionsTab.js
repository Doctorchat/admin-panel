...
export default function TransactionsTab() {
  ...
  const { page, setPage, onTableChange } = useTableState("user-transactions");
  ...
  const fetchTransactions = async () => {
    try {
      ...
      // Use the new API endpoint for user transactions
      const response = await api.stats.getUserTransactions(user_id, params);
